```shell script
../a-star/cmake-build-release/a_star -s 9 -g 5 -n ./inputs/nodes_1.txt -e ./inputs/edges_with_costs_1.txt -p ./outputs/path_output_1.txt -t ./outputs/search_output_1.txt -v -w 2
start_id: 9, goal_id: 5, weight: 2, verbose: 1
...
Start Node: node_id: 9, x: 98.7975, y: 14.8877, p_node_id: 0, status: closed, g_cost: 0, h_cost: 178.004, f_cost: 178.004
Goal Node: node_id: 5, x: 48.4548, y: 88.2838, p_node_id: 7, status: closed, g_cost: 104.541, h_cost: 0, f_cost: 104.541
...
```shell script
../a-star/cmake-build-release/a_star -s 88 -g 9 -n ./inputs/nodes_2.txt -e ./inputs/edges_with_costs_2.txt -p ./outputs/path_output_2.txt -t ./outputs/search_output_2.txt -v -w 2
start_id: 88, goal_id: 9, weight: 2, verbose: 1
...
The search was successful. It took 5 microseconds.
Start Node: node_id: 88, x: 96.6053, y: 11.9207, p_node_id: 0, status: closed, g_cost: 0, h_cost: 214.784, f_cost: 214.784
...
```shell script
../a-star/cmake-build-release/a_star -s 30 -g 95 -n ./inputs/nodes_3.txt -e ./inputs/edges_with_costs_3.txt -p ./outputs/path_output_3.txt -t ./outputs/search_output_3.txt -v -w 2
start_id: 30, goal_id: 95, weight: 2, verbose: 1
...
The search was unsuccessful. It took 9 microseconds.
Start Node: node_id: 30, x: 69.9965, y: 7.41126, p_node_id: 0, status: closed, g_cost: 0, h_cost: 173.717, f_cost: 173.717
...
```shell script
../a-star/cmake-build-release/a_star -s 38 -g 5002 -n ./inputs/nodes_5.txt -e ./inputs/edges_with_costs_5.txt -p ./outputs/path_output_5.txt -t ./outputs/search_output_5.txt -v -w 2
start_id: 38, goal_id: 5002, weight: 2, verbose: 1
...
The search was successful. It took 60 microseconds.
Start Node: node_id: 38, x: 2.53307, y: 20.9627, p_node_id: 0, status: closed, g_cost: 0, h_cost: 191.211, f_cost: 191.211
Goal Node: node_id: 5002, x: 94.2334, y: 48.0076, p_node_id: 4792, status: closed, g_cost: 130.333, h_cost: 0, f_cost: 130.333
