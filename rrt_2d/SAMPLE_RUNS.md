```shell script
./cmake-build-release/rrt_2d -s '(0,0)' -g '(-38,20,10)' -e 10 -o ./inputs/obstacles.txt -p ./outputs/path_output_1.txt -t ./outputs/search_output_1.txt -v -r 20
start: x: 0, y: 0 , goal: x: -38, y: 20 , r: 10 , bias: 0, seed: 20, epsilon: 10, verbose: 1, iter_lim: 100000000
...
The search was successful. It took 38 microseconds.
Start: x: 0, y: 0
Goal: x: -38, y: 20 , r: 10
...
```shell script
./cmake-build-release/rrt_2d -s '(27,30)' -g '(-48,20,10)' -e 5 -o ./inputs/obstacles.txt -p ./outputs/path_output_2.txt -t ./outputs/search_output_2.txt -v -r 20
start: x: 27, y: 30 , goal: x: -48, y: 20 , r: 10 , bias: 0, seed: 20, epsilon: 5, verbose: 1, iter_lim: 100000000
obs_fp: ./inputs/obstacles.txt
...
The search was successful. It took 59 microseconds.
Start: x: 27, y: 30
Goal: x: -48, y: 20 , r: 10
...
```shell script
./cmake-build-release/rrt_2d -s '(-16,10)' -g '(18,-45,5)' -e 2 -o ./inputs/obstacles.txt -p ./outputs/path_output_4.txt -t ./outputs/search_output_4.txt -v -r 20
start: x: -16, y: 10 , goal: x: 18, y: -45 , r: 5 , bias: 0, seed: 20, epsilon: 2, verbose: 1, iter_lim: 100000000
obs_fp: ./inputs/obstacles.txt
...
The search was successful. It took 568 microseconds.
Start: x: -16, y: 10
Goal: x: 18, y: -45 , r: 5
...
```shell script
./cmake-build-release/rrt_2d -s '(39,5)' -g '(38,-8,3)' -e 1 -o ./inputs/obstacles.txt -p ./outputs/path_output_5.txt -t ./outputs/search_output_5.txt -v -r 20
start: x: 39, y: 5 , goal: x: 38, y: -8 , r: 3 , bias: 0, seed: 20, epsilon: 1, verbose: 1, iter_lim: 100000000
obs_fp: ./inputs/obstacles.txt
...
The search was successful. It took 14481 microseconds.
Start: x: 39, y: 5
Goal: x: 38, y: -8 , r: 3
