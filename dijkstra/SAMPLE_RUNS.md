```shell script
../a-star/cmake-build-release/a_star -s 9 -g 5 -n ./inputs/nodes_1.txt -e ./inputs/edges_with_costs_1.txt -p ./outputs/path_output_1.txt -t ./outputs/search_output_1.txt -v -w 0
start_id: 9, goal_id: 5, weight: 0, verbose: 1
...
The search was successful. It took 2 microseconds.
Start Node: node_id: 9, x: 98.7975, y: 14.8877, p_node_id: 0, status: closed, g_cost: 0, h_cost: 0, f_cost: 0
...
```shell script
../a-star/cmake-build-release/a_star -s 88 -g 9 -n ./inputs/nodes_2.txt -e ./inputs/edges_with_costs_2.txt -p ./outputs/path_output_2.txt -t ./outputs/search_output_2.txt -v -w 0
start_id: 88, goal_id: 9, weight: 0, verbose: 1
...
The search was successful. It took 15 microseconds.
Start Node: node_id: 88, x: 96.6053, y: 11.9207, p_node_id: 0, status: closed, g_cost: 0, h_cost: 0, f_cost: 0
...
```shell script
../a-star/cmake-build-release/a_star -s 30 -g 95 -n ./inputs/nodes_3.txt -e ./inputs/edges_with_costs_3.txt -p ./outputs/path_output_3.txt -t ./outputs/search_output_3.txt -v -w 0
start_id: 30, goal_id: 95, weight: 0, verbose: 1
...
The search was unsuccessful. It took 6 microseconds.
Start Node: node_id: 30, x: 69.9965, y: 7.41126, p_node_id: 0, status: closed, g_cost: 0, h_cost: 0, f_cost: 0
...
```shell script
../a-star/cmake-build-release/a_star -s 38 -g 5002 -n ./inputs/nodes_5.txt -e ./inputs/edges_with_costs_5.txt -p ./outputs/path_output_5.txt -t ./outputs/search_output_5.txt -v -w 0
start_id: 38, goal_id: 5002, weight: 0, verbose: 1
...
The search was successful. It took 1704 microseconds.
Start Node: node_id: 38, x: 2.53307, y: 20.9627, p_node_id: 0, status: closed, g_cost: 0, h_cost: 0, f_cost: 0
